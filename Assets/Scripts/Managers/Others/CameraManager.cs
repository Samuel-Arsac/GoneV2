...
public class CameraManager : MonoBehaviour
{
    ...
    [SerializeField] private float zoomOutMax = 3.5f;
    ...
    */
    ...
    private void Start() 
    {
        ...
        /*if(allowToMove)
        {
            UIManagerDebug.instance.RefreshDropdownValues();
            ...
            UIManagerDebug.instance.RefreshRightTextValue(rightEdgeValue);
            UIManagerDebug.instance.RefreshLeftTextValue(leftEdgeValue);
            UIManagerDebug.instance.RefreshTopTextValue(topEdgeValue);
            UIManagerDebug.instance.RefreshBottomTextValue(bottomEdgeValue);
        }*/
    ...
    public void PanScreen(float x, float y)
    {
        ...
        {
            Vector2 direction = PanDirectionUp(x,y);
